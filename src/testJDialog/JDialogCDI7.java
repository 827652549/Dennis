...
import jiemianModularization.*;

public class JDialogCDI7 extends JPanel{
	String value;
	SQL sql;
	int row;
	int I_WIDTH = 1090;
	...
	//传入输入的值
	public JDialogCDI7(String value) {
		this.value = value;
	...
	public Object[][] makeTableDate() throws SQLException{
		...
		String sqlWords = "select * from record where id_VIP="+value;
		/**
